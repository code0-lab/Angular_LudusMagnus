...
export class Cursus implements OnInit { //yarı türkçe yarı ingilizce olduğu yetmez gibi dosya adıda flamenkçe :))
  cursus: ICursus[] = [];
  paginatedCursus: ICursus[] = []; // Sayfalanmış kurslar
